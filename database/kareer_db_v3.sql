...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2022 at 01:45 AM
...
INSERT INTO `course` (`id`, `instructor_id`, `title`, `description`, `categoty_id`, `price`, `is_active`, `created_time`, `picture`, `is_approved`, `is_drafted`, `is_submitted`) VALUES
...
(9, 3, 'Learn Django', 'Django is a Python-based free and open-source web framework that follows the model–template–views architectural pattern. It is maintained by the Django Software Foundation, an independent organization established in the US as a 501 non-profit.', 1, 35, 0, '2022-05-05 21:43:57', 'uploads/django-dark3Learn Django165178703717711991176274451d001a7.jpg', 0, 1, 0);
