...
--
-- Host: 127.0.0.1
-- Generation Time: May 07, 2022 at 07:00 PM
...
INSERT INTO `content` (`id`, `section_id`, `name`, `description`, `url`, `is_preview`) VALUES
(2, 1, 'What is java', 'Java is a high-level, class-based, object-oriented programming language that is designed to have as few implementation dependenc', 'l9AzO1FMgM8', 1),
(3, 2, 'Variables', 'A variable is a container which holds the value while the Java program is executed. A variable is assigned with a data type. Var', 'N8LDSryePuc', 0),
(4, 3, 'Java Sockets', 'A socket in Java is one endpoint of a two-way communication link between two programs running on the network. A socket is bound ', 'BqBKEXLqdvI', 0),
(5, 2, 'Conditional Statements', 'Java has the following conditional statements: Use if to specify a block of code to be executed, if a specified condition is tru', 'P6ivQ3QRq0I', 0),
(6, 6, 'Intro to Python', 'Python is a high-level, interpreted, general-purpose programming language. Its design philosophy emphasizes code readability wit', 'Y8Tko2YC5hA', 1);
...
(8, 3, '30 days web development', 'Web development is the work involved in developing a website for the Internet or an intranet. Web development can range from developing a simple single static page of plain text to complex web applications.', 3, 20, 0, '2022-05-05 21:43:05', 'uploads/top11330 days web development1651786985249541840627444e9192f0.jpg', 0, 1, 0),
(9, 3, 'Learn Django', 'Django is a Python-based free and open-source web framework that follows the model–template–views architectural pattern. It is maintained by the Django Software Foundation, an independent organization established in the US as a 501 non-profit.', 1, 35, 0, '2022-05-06 20:36:28', 'uploads/django-dark3Learn Django165178703717711991176274451d001a7.jpg', 0, 1, 0),
(10, 3, 'Java Master Class', 'Java is a high-level, class-based, object-oriented programming language that is designed to have as few implementation dependencies as possible.Java is used to write applications for different platforms that run JRE and supports applications that run on a ', 3, 15, 0, '2022-05-06 21:34:37', 'uploads/java3Java Master Class1651872877935880676275946deac19.jpg', 0, 1, 0),
(11, 5, 'The Complete Web Development Bootcamp', 'Web development is the work involved in developing a website for the Internet or an intranet. Web development can range from developing a simple single static page of plain text to complex web applications, electronic businesses, and social network service', 3, 30, 0, '2022-05-06 21:36:50', 'uploads/Teachable Thumbnails (1)5The Complete Web Development Bootcamp1651873010587617727627594f2ca9cf.jpg', 0, 1, 0);
